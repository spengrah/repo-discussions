...
This directory contains async discussion threads using the [repo-discussions](https://github.com/spengrah/repo-discussions) protocol — one markdown file per post, frontmatter for threading, conflict-free under concurrent writes.
...
The `discussions` skill teaches an agent how to post, reply, render threads, and manage topics. It lives in the [repo-discussions](https://github.com/spengrah/repo-discussions) repo alongside the protocol spec and consumer template.
...
- [Protocol specification (canonical)](https://github.com/spengrah/repo-discussions/blob/main/PROTOCOL.md)
- [Skill (procedural guide)](https://github.com/spengrah/repo-discussions/blob/main/skills/discussions/SKILL.md)
